...
/**
 * check_base_2 - Convert a number to base 2
 ...
 */
int check_base_2(va_list ptr, char **add)
{
...
/**
 * check_case_S - custom conversion specifier
 * @ptr: A variable that points to a list of arguments
 * @add: A pointer pointing to a memory address within the buffer
 *
 * Return: length of string added to buffer
 */
int check_case_S(va_list ptr, char **add)
{
