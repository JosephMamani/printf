...
/**
 * check_case_u - Add the argument unsigned int to the buffer
 * @ptr: A variable that points to a list of arguments
 * @add: A pointer pointing to a memory address within the buffer
 *
 * Return: length of string added to buffer
 */
int check_case_u(va_list ptr, char **add)
{
...
/**
 * check_case_address - Add the argument hexadecimal to the buffer
 * @ptr: A variable that points to a list of arguments
 * @add: A pointer pointing to a memory address within the buffer
 *
 * Return: length of string added to buffer
 */
int check_case_address(va_list ptr, char **add)
{
