...
int check_case_u(va_list ptr, char **);
int check_case_S(va_list ptr, char **);
int check_case_address(va_list ptr, char **);

int check_base_10(va_list, char **);
int check_base_2(va_list, char **);
int check_base_8(va_list, char **);
int check_base_16_lower(va_list, char **);
int check_base_16_upper(va_list, char **);
